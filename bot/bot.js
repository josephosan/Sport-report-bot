...
exports.bot.start(function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, helpers_1.getUpdates)()];
            case 1:
                _a.sent();
...
exports.bot.on('message', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!config_1.privilegedUsernames.includes(ctx.update.message.from.username)) return [3 /*break*/, 2];
                if (!ctx.update.message.text.includes('GLOBAL MESSAGE:')) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, helpers_1.messageAllUsers)(ctx.update.message.text.split('GLOBAL MESSAGE:')[1])];
            case 1:
                _a.sent();
                return [2 /*return*/];
            case 2:
                if (!config_1.acceptedKeywords.includes(ctx.update.message.text)) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, db_1.updateUsersDailyState)(ctx.update.message.from.username)];
            case 3:
                _a.sent();
